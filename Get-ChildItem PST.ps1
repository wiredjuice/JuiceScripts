...
if($firstOutput)
{
Write-output $output | Out-File -Encoding ascii -filepath "C:\ittemp\pstdetails.csv"
$firstOutput = $false
}
else
{
Write-output $output | Out-File -Encoding ascii -filepath "C:\ittemp\pstdetails.csv" -append
}
}
}
}